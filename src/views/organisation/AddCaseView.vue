...
const tarifs = [
  {
    ...
    stars: 3,
    cost: 500,
    advantages: ['Публикация на месяц (с возможностью продления)', '1 направление по кейсу', '30 решений']
  },
  {
    title: 'Тариф "Стандарт"',
    stars: 4,
    cost: 900,
    advantages: ['Публикация на 2 месяца (с возможностью продления)', 'От 1 до 2 направлений по кейсу', '30 решений', 'Поднятие в ленте каждые 15 дней', 'Выделение кейса на 10 дней']
  },
  {
    title: 'Тариф "Премиум"',
    stars: 5,
    cost: 1300,
    advantages: ['Публикация на 3 месяца (с возможностью продления)', 'От 1 до 3 направлений по кейсу', 'Неограниченное кол-во решений', 'Поднятие в ленте каждые 5 дней', 'Выделение кейса на 3 месяца', 'Чат с участниками']
  }
]
...
<template>
  <div class="main-container">
    <h2>Новый кейс</h2>
    <OISimpleSelect style="margin-top: 16px; margin-bottom: 20px" @selectedValue="(slot) => (selected = slot)">
    ...
    <div v-else class="new-case">
      ...
      <OIOptionsSelect :options="['Обычный', 'Организация']" default-select="Выберите направление" />
        <OIInput placeholder="Введите название">Название кейса</OIInput>
      <OIInput big placeholder="Введите описание кейса..">
        Описание кейса
      </OIInput>
      ...
      <div class="new-case__buttons">
        <OIButton>Опубликовать</OIButton>
      </div>
    </div>
  </div>
</template>
